...
setup(
    ...
    install_requires=[
        ...
        'matplotlib>=3.5.1',
        'uvloop>=0.16',
        'purepyindi2 @ git+http://git@github.com/xwcl/purepyindi2.git',
        'magpyx @ git+http://git@github.com/magao-x/magpyx.git',
        'purepyindi @ git+http://git@github.com/magao-x/purepyindi.git',
        'imagestreamiowrap @ git+http://git@github.com/milk-org/ImageStreamIO.git',
        'xconf @ git+http://git@github.com/xwcl/xconf.git',
        'toml>=0.10.2',
        'websockets>=10.2',
        'blosc>=1.11.1',
    ],
